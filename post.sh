...
post() {
  echo "Sending $1"
  curl -X POST -H "Content-Type: application/json" -d "$1" http://localhost:8102/publish
}
...
post '{"id":"id-10","name":"name-10","count":10,"amount":10.10,"childObject":{"description":"desc-10"}}'